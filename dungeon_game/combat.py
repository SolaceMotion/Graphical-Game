...
class Combat():
    def __init__(self, player: Player, enemy: Enemy):
        ...
        self.player = player
        self.player.set_pos(
            (self.width // 2 + self.road_w // 4, int(self.height * 4 // 5)))
        self.enemy = enemy
    ...
    def draw(self, screen: pygame.Surface):
        ...
        pygame.draw.rect(screen, (155, 150, 150), (self.width //
                         2 - self.road_w//2, 0, self.road_w, self.height))
        pygame.draw.rect(screen, (255, 255, 60), (self.width //
                         2 - self.road_mark//2, 0, self.road_mark, self.height))
        pygame.draw.rect(screen, (255, 255, 255), (self.width//2 - self.road_w //
                         2 + self.road_mark*2, 0, self.road_mark, self.height))
        pygame.draw.rect(screen, (255, 255, 255), (self.width//2 + self.road_w //
                         2 - self.road_mark*3, 0, self.road_mark, self.height))
            ...
            for event in pygame.event.get():
                ...
                if event.type == KEYDOWN:
                    ...
                    if event.key in [K_d, K_RIGHT]:
                        self.player.set_pos(
                            (self.right_lane, self.height*4//5))
            self.draw(screen)
